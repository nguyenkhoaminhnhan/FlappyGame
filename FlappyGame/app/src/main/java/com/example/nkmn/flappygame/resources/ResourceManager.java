...
public class ResourceManager {
    ...
    private void loadGameFonts() {
        ...
        FontFactory.setAssetBasePath("font/");
        mFont2 = FontFactory.createFromAsset(mActivity.getFontManager(), mActivity.getTextureManager(), 256, 256, mActivity.getAssets(), "flappy.ttf", 40, true, Color.YELLOW);
        mFont2.load();
